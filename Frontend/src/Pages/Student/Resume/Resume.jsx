...
const Resume = () => {
  ...
  const deleteJobHandler = async (id) => {
    ...
    error ? toast.error(error.data.message) : toast.success("Job deleted");
  };
  ...
  const deletecourseHandler = async (id) => {
    ...
    error ? toast.error(error.data.message) : toast.success("Course deleted");
  };
  const deleteprojectHandler = async (id) => {
    ...
    error ? toast.error(error.data.message) : toast.success("Project deleted");
  };
  const deleteskillHandler = async (id) => {
    ...
    error ? toast.error(error.data.message) : toast.success("Skill deleted");
  };
