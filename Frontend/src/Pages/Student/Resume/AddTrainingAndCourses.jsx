...
import { addTrainingCourse, editTrainingCourse } from '../../../store/Actions/userActions'
...
const AddTrainingAndCourses = ({ edit = false }) => {
  ...
  useEffect(() => {
    const descriptionValue = watch((value, { name }) => {
      ...
      if (name == "workType") {
        value.workType ? setValue("Location", "Online")
          : setValue("Location", "")
      }
      ...
      <div className='w-full h-[100px
        ...
        <form
          ...
          <div>
            ...
            />
            {errors.training && <p className="text-red-500 text-sm mt-1 flex items-center gap-1"><MdErrorOutline /> <span>{errors.training.message}</span></p>}
          </div>
