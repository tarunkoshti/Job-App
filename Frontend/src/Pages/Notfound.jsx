  ...
  return (
    <div className='mt-10 flex flex-col tracking-widest'>
      ...
      <div className='flex flex-col md:flex-row items-center justify-center mt-16 gap-5 md:gap-10'>
        <NavLink to='/'><button className='py-2 px-6 md:py-3 md:px-6 bg-[#2507B3] text-md md:text-md text-white rounded-lg tracking-wider'>Go Back Home</button></NavLink>
        <div className='flex items-center gap-2 mt-4 md:mt-0'>
          <NavLink to='/support'><button className='text-md md:text-lg tracking-wider'>Contact Support</button></NavLink>
          <FaArrowRight />
        </div>
      </div>
    </div>
