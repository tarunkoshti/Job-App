                ...
                <View key={item.id} style={styles.item}>
                    {item?.college && (
                        <View>
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                                {item?.branch && (
                                    <Text style={styles.school}>{item?.degree}, ({item?.branch})</Text>
                                )}
                                ...
                                <Text style={styles.dateRange}>{item?.startYear} - {item?.lastYear}</Text>
                            </View>
                    ...
                    {item?.school && (
                        <View>
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                                {item?.stream ? (
                                    <Text style={styles.school}>Higher Secondary, ({item?.board})</Text>
                                ) : (
                                    <Text style={styles.school}>High Secondary, ({item?.board})</Text>
                                )}
                                <Text style={styles.dateRange
                                }>{item?.completionYear}</Text>
                            </View>
