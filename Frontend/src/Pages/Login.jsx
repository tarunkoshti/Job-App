      ...
      <div style={style} className={`mx-auto w-full max-w-lg bg-white rounded-xl p-10 `}>
        ...
        <div className='w-full flex justify-around font-medium text-xl gap-2'>
          <div className='w-1/2 flex flex-col overflow-hidden'>
            <Link to={`/student/login`} className='text-center mb-2'>Student</Link>
            <motion.div
              initial={{ x: "100%" }}
          ...
          <div className='w-1/2 flex flex-col overflow-hidden'>
            <Link to={`/employee/login`} className='text-center mb-2'>Employee</Link>
            <motion.div
              initial={{ x: "-100%" }}
        ...
        >
          <div className='space-y-5'>
            ...
            >
              {loader ? (<CgSpinner class="animate-spin h-5 w-5 mr-3 text-white text-center" />) : "Login"}
            </Button>
