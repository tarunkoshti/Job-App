    ...
    <>
      ...
      <div className="mt-5">
        ...
        <div className="py-4 px-4 md:pl-16 md:ml-6">
          <h6 className="w-full md:w-3/5 text-lg tracking-wider">
            So, what is <span className="text-[#2507B3]">Hirer</span>? We’re a
            thriving community for workplace conversations, driven by a simple
            mission: helping people everywhere find jobs and companies they
            love.
          </h6>
          <br />
          <h6 className="w-full md:w-3/5 text-lg tracking-wider">
        ...
        <div className="mt-10 md:mt-28 flex flex-col items-center">
          <h1 className="text-center text-xl md:text-3xl py-5 font-medium">
            What we do
          </h1>
          <h3 className="text-center text-md md:text-lg w-full md:w-1/2 tracking-wide">
            Wherever you are on your career journey, Glassdoor makes it easier
            for workers and companies to find the perfect match.
          </h3>
        </div>

        <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-28 mt-8 md:mt-16 px-10">
          <div className="p-6 md:p-12 rounded-xl hover:shadow-2xl shadow-xl hover:text-black duration-500 cursor-pointer">
            <h1 className="font-medium py-2 text-lg md:text-2xl text-[#2507B3]">
              For job seekers
            </h1>
            <p className="w-full md:w-56 tracking-wide text-md md:text-lg ml-4">
          ...
          <div className="p-6 md:p-12 rounded-xl hover:shadow-2xl shadow-xl hover:text-black duration-500 cursor-pointer">
            ...
            <p className="w-full md:w-56 tracking-wider text-md md:text-lg ml-4">
        ...
        <div className="mt-10 md:mt-28 flex flex-col items-center">
          <h1 className="text-center text-2xl md:text-4xl py-5 font-medium capitalize">
            <span className="text-[#2507B3]">Hirer</span> by the numbers
          </h1>
          <h3 className="text-center text-md md:text-lg w-full md:w-1/2 tracking-wide">
