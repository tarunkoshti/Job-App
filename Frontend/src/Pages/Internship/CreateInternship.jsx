            ...
            <form onSubmit={handleSubmit(create)} className="">
                ...
                <div className="w-full flex flex-col items-center py-8 border-2 border-zinc-200 rounded-lg">
                  ...
                  <div className="w-full md:max-w-lg mt-3">
                    ...
                    {errors.openings && (
                      <p className="text-red-500 text-sm mt-1 flex items-center gap-1">
                        <MdErrorOutline />{" "}
                        <span>{errors.openings.message}</span>
                      </p>
                    )}
                  </div>
                  ...
                  <div className="w-full md:max-w-lg mt-1">
                    ...
                    <div className="flex flex-col ml-4">
                      ...
                      <div className="flex items-center">
                        ...
                        />
                        <label
                          htmlFor="freeSnacksAndBeverages"
                          className="ml-2"
                        >
              ...
              <div className=" mt-5 p-3 rounded-lg">
                ...
                <div className="w-full mt-2  flex flex-col items-center py-8 border-2 border-zinc-200 rounded-lg">
                  ...
                  {/* Assessments */}
                  <div className="w-full md:max-w-lg mt-1">
                    <label htmlFor="assessments" className="block mb-2">
                      Assessments:
                    </label>
                    <textarea
                      id="assessments"
                  ...
                  {/* Work conditions */}
                  <div className="w-full md:max-w-lg mt-1">
                    <label htmlFor="workconditions" className="block mb-2">
                      Work Conditions:
                    </label>
                    <textarea
                      id="workconditions"
                  ...
                  {/* Company Detail */}
                  <div className="w-full md:max-w-lg mt-1">
                    <label htmlFor="companyDetail" className="block mb-2">
                      Company Detail:
                    </label>
                    <textarea
                      id="companyDetail"
