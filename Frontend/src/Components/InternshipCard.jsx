    ...
    return (
        <div className='snap-center'>
            <Link to={`/student/internships/read/${internship._id}`}>
                ...
                <div key={internship._id} className={`m-2 w-80 mb-5 p-4 shrink-0 rounded-xl bg-white text-black border ${colors[index % colors.length]}`}>
                    ...
                    <div className='flex items-center justify-between '>
                        <div className='flex items-center gap-2 py-1 px-3 border rounded-md'>
                            ...
                            <h3 className='font-medium text-xs'>posted {differenceInDays} days ago</h3>
                        </div>
                    ...
                    <div className='py-4 border-b flex justify-between items-center'>
                        <div>
                            <div className=''>
                                <h3 className='text-lg font-semibold capitalize text-gray-700'>{internship.profile}</h3>
                            </div>

                            <div className=''>
                                <h3 className='text-sm font-medium capitalize text-gray-500'>{internship.company}</h3>
                            </div>
                        </div>
