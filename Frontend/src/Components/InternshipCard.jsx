    ...
    return (
        <>
           <Link to={`/student/internship/read/${internship._id}`}>
             ...
             <div key={internship._id} className='w-80  bg-white shrink-0 rounded-xl mb-5 p-1'>

                <div className={`m-2 rounded-xl pb-16 ${colors[index % colors.length]}`}>
                    ...
                    <div className='flex items-center text-center font-medium mt-4 ml-3'>
                        <div className='py-1 px-2 text-center bg-white w-32 rounded-lg ml-5'>
                            <h3 className=' text-sm text-center font-medium'>₹ {internship.stipend.amount} /- Month</h3>
                        </div>
