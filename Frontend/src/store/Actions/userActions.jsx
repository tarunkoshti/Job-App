...
export const applyinternship = (id) => async (dispatch, getState) => {
  try {
    const { data } = await axios.post(
      `/api/user/student/apply/internship/${id}`
    );
    console.log(data);
    dispatch(currentUser({ data }));
  } catch (error) {
...
export const bookmarkinternship = (id) => async (dispatch, getState) => {
  try {
    const { data } = await axios.post(
      `/api/user/student/bookmark/internship/${id}`
    );
    console.log(data);
    dispatch(currentUser({ data }));
  } catch (error) {
...
export const disbookmarkinternship = (id) => async (dispatch, getState) => {
  try {
    const { data } = await axios.post(
      `/api/user/student/disbookmark/internship/${id}`
    );
    console.log(data);
    dispatch(currentUser({ data }));
  } catch (error) {
...
export const disbookmarkjob = (id) => async (dispatch, getState) => {
  try {
    const { data } = await axios.post(
      `/api/user/student/disbookmark/job/${id}`
    );
    console.log(data);
    dispatch(currentUser({ data }));
  } catch (error) {
